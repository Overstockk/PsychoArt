 ...
 */            (function(window, factory) {
    ...
    (() => {
        ...
        document.addEventListener("click", documentCollections);
        function documentCollections(e) {
            const targetElement = e.target;
            if (targetElement.closest(".filter-collections__item")) {
                const filterItem = targetElement.closest(".filter-collections__item");
                const filterValue = filterItem.dataset.filter;
                const filterActiveItem = document.querySelector(".filter-collections__item._active-colections");
                filterValue === "art" ? itemsGrid.arrange({
                    filter: ``
                }) : itemsGrid.arrange({
                    filter: `[data-filter="${filterValue}"]`
                });
                filterActiveItem.classList.remove("_active-colections");
                filterItem.classList.add("_active-colections");
                e.preventDefault();
            }
        }
        ...
        document.addEventListener("click", (function(e) {
            if (e.target.classList.contains("author__button")) {
                const button = e.target;
                if (button.classList.contains("_active-subscribe")) {
                    button.classList.remove("_active-subscribe");
                    button.textContent = "Subscribe";
                } else {
                    button.classList.add("_active-subscribe");
